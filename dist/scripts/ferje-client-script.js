(() => {
  ...
  var AUTO_LOCATE_STORAGE_KEY = "ferjetider:auto-locate-disabled";
  var LEGACY_SETTINGS_STORAGE_KEY = "allowedSettings";
  var REDIRECT_STORAGE_KEY = "ferjetider:redirected-to-nearest";
  ...
  function setAutoLocateDisabled(disabled) {
